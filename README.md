...
- [ ] Explain what a token is used for.
  - A token is used to provide authentication to or from a server in the form of a randomly generated encrypted key.
- [ ] What steps can you take in your web apps to keep your data secure?
  - You may use tokens and have your data only be accessible if a token is passed along when making a request.
- [ ] Describe how web servers work.
  - Web servers handle newtwork requests primarily over HTTP. Web servers store, process, and deliver data
